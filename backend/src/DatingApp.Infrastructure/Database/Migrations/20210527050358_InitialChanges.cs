    ...
    public partial class InitialChanges : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("uk_like", x => new { x.sender_id, x.receiver_id });
                    table.ForeignKey(
                        name: "fk_like_user_receiver",
                        column: x => x.receiver_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_like_user_sender",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sent_at = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, defaultValue: new DateTimeOffset(new DateTime(2021, 5, 27, 5, 3, 58, 246, DateTimeKind.Unspecified).AddTicks(2260), new TimeSpan(0, 0, 0, 0, 0))),
                    sender_deleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    recipient_deleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
